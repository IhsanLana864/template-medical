                ...
                <div class="card stretch stretch-full">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover" id="kegiatanTable">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Gambar</th>
                                    ...
                                    @forelse ($kegiatans as $kegiatan)
                                        <tr class="single-item">
                                            ...
                                            <td class="d-flex align-items-center gap-3 ps-4 py-3">
                                                <img src="{{ asset('storage/' . $kegiatan->gambar) }}" alt="Kegiatan"
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    <a href="{{ route('admin.kegiatan.edit', $kegiatan->id) }}" class="avatar-text avatar-md">
