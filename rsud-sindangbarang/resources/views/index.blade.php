...
@section('content')
    ...
    <section class="banner-2 banner-2__space theme-bg-color-900 overflow-hidden"
        data-background="assets/imgs/banner-2/Banner-rsud.png">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="banner-2__content">
                        ...
                        <p class="mb-50 mb-xs-40 color-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                            sit amet rcus nunc. Duis egestas ac ante sed to go a tincidunt Lorem</p>
                ...
                <div class="col-lg-6">
                    <div class="about-us-2__main-content">
                        <div class="section__title-wrapper about-us-2__content mb-60 mb-xs-50">
                            ...
                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet rcus
                        ...
                        <div class="about-us-2__main-content__list">
                            <div class="about-us-2__main-content__list-item">
                                ...
                                <div class="about-us-2__main-content__list-item-text">
                                    ...
                                    <p class="mb-0">Nemo enim ipsam voluptatem quia voluptas sit aspernatur odit aut fugit
                                    </p>
                                </div>
                            </div>
                            <div class="about-us-2__main-content__list-item">
                                ...
                                <div class="about-us-2__main-content__list-item-text">
                                    ...
                                    <p class="mb-0">Nemo enim ipsam voluptatem quia voluptas sit aspernatur odit aut
                                        fugit</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row mb-minus-30">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="service-4__item mb-30">
                        ...
                        <div class="service-4__item-text">
                            <h4 class="mb-15 mb-xs-10 title-animation"><a href="service-details.html">Health Solutions</a>
                            </h4>
                            <p>Lorem ipsum dolor sit consectetur adipiscing elit. Sed sit amet rcus nunc. Duis egestas ac
                                ante sed tincidunt. Lorem ipsum dolor </p>
                            <a class="rr-a-btn" href="service-details.html">Read More <i
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="service-4__item mb-30">
                        ...
                        <div class="service-4__item-text">
                            <h4 class="mb-15 mb-xs-10 title-animation"><a href="service-details.html">VitalVista
                                    Services</a></h4>
                            <p>Lorem ipsum dolor sit consectetur adipiscing elit. Sed sit amet rcus nunc. Duis egestas ac
                                ante sed tincidunt. Lorem ipsum dolor </p>
                            <a class="rr-a-btn" href="service-details.html">Read More <i
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="service-4__item mb-30">
                        ...
                        <div class="service-4__item-text">
                            <h4 class="mb-15 mb-xs-10 title-animation"><a href="service-details.html">Nourish Net
                                    Healthcare</a></h4>
                            <p>Lorem ipsum dolor sit consectetur adipiscing elit. Sed sit amet rcus nunc. Duis egestas ac
                                ante sed tincidunt. Lorem ipsum dolor </p>
                            <a class="rr-a-btn" href="service-details.html">Read More <i
                ...
                <div class="col-12">
                    <div class="section__title-wrapper doctor__content text-center mb-60 mb-xs-30">
                        <h5 class="section__subtitle color-theme-primary mb-15 mb-xs-10 title-animation"><img
                                ...
                                class="img-fluid">Specialist Doctor</h5>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 d-flex">
                    <div class="our-projects__item has--title">
                        <div class="section__title-wrapper our-projects__content">
                            <h5 class="section__subtitle color-theme-primary"><img
            ...
            <div class="row align-items-end mb-60 mb-sm-50 mb-xs-40">
                ...
                <div class="col-lg-6">
                    <div class="appointment-2__content-right">
                        <p class="mb-0">Medical science encompasses a vast array of fields dedicated to understanding and
                            treating ailments, promoting health, and enhanci quality of life. Here's a brief exploration
                            into this multifaceted domain medical student company remain</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section__title-wrapper pricing-action__content text-center mb-60 mb-xs-50">
                        <h5 class="section__subtitle color-theme-primary mb-15 mb-xs-10 title-animation"><img
                                src="assets/imgs/ask-quesiton/heart.png" alt="icon not found" class="img-fluid"> Pricing
                            Action</h5>
                        <h2 class="section__title mb-0 text-capitalize title-animation">Empowering wellness one patient at
                            a time</h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-2__item">
                                    <div class="testimonial-2__item-icon mb-35 mb-xs-15">
                                        <img class="img-fluid" src="assets/imgs/testimonial-2/qoute.png"
                                            alt="icon not found">
                                    </div>
                                    <div class="testimonial-2__item-content mb-35 mb-xs-30">
                                        <h3 class="mb-0">Leverage agile frameworks to provide a rob synopsis for strategy
                                            foster Leverage agile frame works to provide a robust synopsi for strategy
                                            foster collaborative thinking to further </h3>
                        ...
                        <div class="testimonial-2__slider__arrow d-flex">
                            <div class="testimonial-2__slider__arrow-prev">
                                <svg width="100" height="60" viewBox="0 0 100 60" fill="none"
                                    ...
                                    <circle cx="30" cy="30" r="29.5" transform="matrix(-1 0 0 1 60 0)"
                                        stroke="#E4E5E5" />
                                    <path
                                        d="M28.9393 28.9393C28.3536 29.5251 28.3536 30.4749 28.9393 31.0607L38.4853 40.6066C39.0711 41.1924 40.0208 41.1924 40.6066 40.6066C41.1924 40.0208 41.1924 39.0711 40.6066 38.4853L32.1213 30L40.6066 21.5147C41.1924 20.9289 41.1924 19.9792 40.6066 19.3934C40.0208 18.8076 39.0711 18.8076 38.4853 19.3934L28.9393 28.9393ZM30 31.5H100V28.5H30V31.5Z"
                                        fill="#E4E5E5" />
                                </svg>
                            </div>
                            ...
                            <div class="testimonial-2__slider__arrow-next">
                                <svg width="100" height="60" viewBox="0 0 100 60" fill="none"
                                    ...
                                    <path
                                        d="M71.0607 28.9393C71.6464 29.5251 71.6464 30.4749 71.0607 31.0607L61.5147 40.6066C60.9289 41.1924 59.9792 41.1924 59.3934 40.6066C58.8076 40.0208 58.8076 39.0711 59.3934 38.4853L67.8787 30L59.3934 21.5147C58.8076 20.9289 58.8076 19.9792 59.3934 19.3934C59.9792 18.8076 60.9289 18.8076 61.5147 19.3934L71.0607 28.9393ZM70 31.5H0V28.5H70V31.5Z"
                                        fill="#E4E5E5" />
                                </svg>
                            </div>
                        </div>
            ...
            <div class="row mb-60 mb-xs-50 align-items-lg-end align-items-center">
                <div class="col-lg-6">
                    <div class="section__title-wrapper blog-2__content">
                        <h5 class="section__subtitle color-theme-primary mb-15 mb-xs-10 title-animation"><img
                                src="assets/imgs/ask-quesiton/heart.png" alt="icon not found" class="img-fluid"> Latest
                            Blog</h5>
                            ...
                            <div class="swiper-slide">
                                <div class="blog-2__item">
                                    <a href="blog-details.html"
                                        class="blog-2__item-media d-block position-relative overflow-hidden">
                                        <div class="panel wow"></div>
                                    ...
                                    <div class="blog-2__item-content">
                                        <ul class="blog-2__item-meta-list mb-35 mb-xs-30">
                                            <li><i class="fa-solid fa-calendar-days"></i> <span>October 19, 2022</span>
                                            </li>
                                            <li><a href="blog-details.html"><i class="fa-regular fa-user"></i>
                                                    <span>Mesbah</span></a></li>
                                        </ul>

                                        <h4 class="mb-15 mb-xs-10"><a href="blog-details.html">Smile Brighter Smile
                                                Healthier Your Dental Destination</a></h4>
                                        <p class="mb-40 mb-xs-30">Explore the dynamic commerce through our insightful
                                            blogs. Learn Explore the dynamic</p>
                            ...
                            <div class="swiper-slide">
                                <div class="blog-2__item">
                                    ...
                                    <div class="blog-2__item-content">
                                        ...
                                        <h4 class="mb-15 mb-xs-10"><a href="blog-details.html">Bringing Confidence to Your
                                                Smile Dental Excellence</a></h4>
                                        <p class="mb-40 mb-xs-30">Explore the dynamic commerce through our insightful
                                            blogs. Learn Explore the dynamic</p>
                            ...
                            <div class="swiper-slide">
                                <div class="blog-2__item">
                                    ...
                                    <div class="blog-2__item-content">
                                        ...
                                        <h4 class="mb-15 mb-xs-10"><a href="blog-details.html">Painting a Brighter Health
                                                Landscape</a></h4>
                                        <p class="mb-40 mb-xs-30">Explore the dynamic commerce through our insightful
                                            blogs. Learn Explore the dynamic</p>
